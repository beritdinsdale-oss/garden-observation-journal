...
function renderMemoryHandoff(){
 ...
 (d.patternAnswers||[]).forEach((a,i)=>{const q=el('div','handoff-answer');q.append(el('p','handoff-question',`${i+1}. ${a.question}`),el('p','handoff-response',a.answer||'—'));if(a.detail)q.append(el('p','handoff-detail',a.detail));ans.append(q)});card.append(ans);
